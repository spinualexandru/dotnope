...
function patchWorkerThreads() {
    ...
    class DotnopeWorker extends OriginalWorker {
        constructor(filename, options = {}) {
            super(filename, createProtectedWorkerOptions(options, workerThreads, bootstrapPath));
        }
    }
...
function restoreWorkerThreads() {
    if (workerThreadsPatched && workerThreadsModule && originalWorker) {
        workerThreadsModule.Worker = originalWorker;
    }
    workerThreadsModule = null;
    originalWorker = null;
    workerThreadsPatched = false;
}
